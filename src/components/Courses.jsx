...
import { newCourses } from '../constants';
...
const Courses = () => (
    <>
        ...
        <p className={styles.sectionSubText}>New Courses</p>
        <h2 className={styles.sectionHeadText}>Added.</h2>
        </motion.div>

        <div className='mt-20 flex flex-wrap gap-10 '>
        {newCourses.map((newCourse, index) => ( 
            <Card key={newCourse.title} index={index} {...newCourse} />
        ))}
        </div>
    </>
);
